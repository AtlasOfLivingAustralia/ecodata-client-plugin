...
<div class="image-gallery">
    <ul class="thumbnails" data-bind="visible: ${name}().length">
        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="projectLogo" data-bs-toggle="popover" data-bs-trigger="hover" data-bs-title="Photo metadata" data-bind="popover: {placement:'top', content: function(){ return $(this).parent().parent().find('.metadata').html()} }">
                <a href=""
