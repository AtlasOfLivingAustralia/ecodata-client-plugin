<div id="" class="fileupload-buttonbar">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" data-bind="value:name" ${validationAttrs?'data-validation-engine="data-validate[groupRequired['+source+']]"':''}
                               class="form-control form-control-sm full-width-input image-title-input">
                    </div>
                </div>
                    ...
                    <div class="col-sm-8">
                        <div class="input-group">
                            <fc:datePicker size=""
                                           ...
                                           name="dateTaken" bs4="true"
                                           data-validation-engine="validate[required]" class="form-control form-control-sm col-sm-10"/>
                        </div>
    ...
    <table class="table table-custom-border borderless" data-bind="${databindAttrs}" data-url="<g:createLink controller='image' action='upload'/>">
        ...
        <tr style="display:${allowImageAdd};">
            ...
            <td>
                <div class="dropzone col-sm-12 p-3">
                    Or, drop images here
                </div>
            </td>
            </g:if>
